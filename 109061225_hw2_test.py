...
class Agent:
    ...
    def preprocess(self, observation):
        """
        Process (crop, resize, normalize) the observation

        Parameters
        observation : np.ndarray
            RGB image observation from the environment
        ----------
        Returns
        preprocessed_observation : torch.tensor
